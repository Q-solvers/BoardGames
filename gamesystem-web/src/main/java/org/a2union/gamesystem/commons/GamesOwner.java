 ...
 * @author Iskakoff
 */
public class GamesOwner implements GridDataSource {
    ...
    public int getAvailableRows() {
        return gameService.countGamesByGameZoneAndOwner(gameZoneId, user);
    }
    ...
    public void prepare(int startIndex, int endIndex, List<SortConstraint> sortConstraints) {
        result = gameService.getGameZoneGamesOwnerPage(gameZoneId, user, startIndex, endIndex - startIndex + 1).iterator();
    }
